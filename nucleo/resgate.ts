...
export function instrucoesDeTarefa(): string {
  return [
    ...
    '- um bloco SEM VERBO explícito ("entregar", "responder", "fazer") ainda É',
    '  uma tarefa quando ele nomeia uma plataforma/material mais um capítulo ou',
    '  número — "Sistema SAS / Eureka Capítulo 10 / Entrega: sexta-feira" é UMA',
    '  tarefa própria (matéria "Sistema SAS", tarefa "Eureka Capítulo 10",',
    '  quando "sexta-feira"), mesmo sem dizer "fazer o Eureka". Falta de verbo',
    '  não é motivo pra apagar a linha — motivo pra apagar é faltar TEXTO;',
